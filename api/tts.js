...
const payload = JSON.stringify({ text: text, model_id: ‘eleven_multilingual_v2’, voice_settings: { stability: 0.30, similarity_boost: 0.90, style: 1.0, use_speaker_boost: true } });
const chunks = [];
